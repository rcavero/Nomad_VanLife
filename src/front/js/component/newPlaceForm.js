...
export const NewPlaceForm = () => {
    return (
        <div className="container-fluid mt-3 mb-0 d-grid justify-content-start pe-2">
            <button type="button" className="btn btn-primary right-button border border-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-plus pe-2"></i>New NomadVanPlace</button>
            {/* <!-- Modal --> */}
