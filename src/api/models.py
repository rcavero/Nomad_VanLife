...
class NomadVanPlace(db.Model):
    ...
    # kindofplace_id = db.Column(db.Integer, db.ForeignKey('kindofplace.id'), nullable=False)
...
#     nomadvanplace = db.relationship('NomadVanPlace', backref='kind_places', lazy=True)

#     def __repr__(self):
#         return '<KindOfPlace %r>' % self.name
...
class Locations(db.Model):
    ...
    todos = db.relationship('Todos', backref='location_todo', lazy=True)
